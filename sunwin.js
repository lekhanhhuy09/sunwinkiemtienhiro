...
const TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Gbzs8xl82xzuRlmwx-mic-yUSq2AFEBNji9nhAacSbA";
...
const start = async () => {
    try {
        ...
        console.log(`\n==============================================`);
        console.log(`🚀 Lekhanhhuy Sunwin AI ULTRA Server`);
        console.log(`==============================================`);
